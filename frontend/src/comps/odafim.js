...
function Cardoos(props) {
    ...
    const imageSource = props.poster1 ? props.poster1 : props.post1;
...
function Odafim() {
    ...
    return (
        <div className='column' style={{ marginBottom: '30px' }}>
            <h1 dir='rtl' style={{ fontWeight: 400, textAlign: "center" }}> עודפים: </h1>
            {rows.map(row => (
